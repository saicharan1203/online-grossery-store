...
FRESH_PRODUCTS = [
    ...
    {"name": "Pineapple", "category": "Fruit", "price": 2.40, "stock": 60, "image_url": "images/pineapple.png",
    ...
    {"name": "Paneer Cubes", "category": "Dairy", "price": 3.70, "stock": 70, "image_url": "images/dairy_paneer.png",
    ...
    {"name": "Farm Eggs", "category": "Dairy", "price": 4.00, "stock": 100, "image_url": "images/dairy_eggs.png",
    ...
    {"name": "Fish Fillet", "category": "Meat", "price": 8.30, "stock": 40, "image_url": "images/meat_fish.png",
     "description": "Fresh white fish fillet"},
    {"name": "Mutton Cuts", "category": "Meat", "price": 11.20, "stock": 30, "image_url": "images/meat_mutton.png",
     "description": "Premium mutton cuts"},
    {"name": "Salmon Steak", "category": "Meat", "price": 9.80, "stock": 35, "image_url": "images/meat_salmon.png",
     "description": "Fresh Atlantic salmon"},
    {"name": "Shrimp Basket", "category": "Meat", "price": 8.10, "stock": 45, "image_url": "images/meat_shrimp.png",
    ...
    {"name": "Quinoa Pack", "category": "Grains", "price": 4.30, "stock": 70, "image_url": "images/grains_quinoa.png",
     "description": "Organic quinoa grains"},
    {"name": "Rolled Oats", "category": "Grains", "price": 3.20, "stock": 90, "image_url": "images/grains_oats.png",
    ...
    # Vegetables
    {"name": "Lettuce Head", "category": "Vegetable", "price": 1.25, "stock": 80, "image_url": "images/veg_lettuce.png",
    ...
    {"name": "Onion Bag", "category": "Vegetable", "price": 0.55, "stock": 150, "image_url": "images/veg_onion.png",
    ...
    {"name": "Green Peas", "category": "Vegetable", "price": 1.35, "stock": 90, "image_url": "images/veg_peas.png",
    ...
    # Snacks
    {"name": "Potato Chips", "category": "Snacks", "price": 2.70, "stock": 100, "image_url": "images/snack_chips.png",
    ...
    {"name": "Ice Cream Tub", "category": "Snacks", "price": 4.30, "stock": 50, "image_url": "images/snack_icecream.png",
     "description": "Vanilla ice cream tub"},
    {"name": "Pretzel Bites", "category": "Snacks", "price": 2.00, "stock": 80, "image_url": "images/snack_pretzel.png",
     "description": "Salted pretzel bites"},
    
    # Pantry
    {"name": "Honey Jar", "category": "Pantry", "price": 6.50, "stock": 60, "image_url": "images/honey jar.webp",
     "description": "Pure natural honey"},
    {"name": "Jam Spread", "category": "Pantry", "price": 3.60, "stock": 70, "image_url": "images/pantry_jam.png",
     "description": "Mixed fruit jam"},
    {"name": "Peanut Butter", "category": "Pantry", "price": 5.00, "stock": 80, "image_url": "images/pantry_peanut.png",
    ...
    {"name": "Lentils Mix", "category": "Pantry", "price": 2.90, "stock": 90, "image_url": "images/pantry_lentils.png",
     "description": "Mixed lentils pack"},
    {"name": "Kidney Beans", "category": "Pantry", "price": 2.70, "stock": 85, "image_url": "images/pantry_beans.png",
    ...
    {"name": "Juice Box", "category": "Beverage", "price": 3.20, "stock": 100, "image_url": "images/bev_juice.png",
     "description": "Fresh fruit juice pack"},
    {"name": "Soft Drink Can", "category": "Beverage", "price": 2.70, "stock": 120, "image_url": "images/bev_softdrink.png",
